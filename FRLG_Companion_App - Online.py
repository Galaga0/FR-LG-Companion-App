...
def rebuild_learnset_for(species_name: str) -> Dict[str, List[str]]:
    """
    Merge Gen3 level-up data with Showdown 3Lxx sources, then apply FRLG overrides.
    Output is { "1": [...], "7": [...], ... } of damaging moves only.
    """
    out: Dict[str, List[str]] = {}

    # 1) Gen3 compiled dataset
    ...
    # 2) Showdown learnsets: only Gen3 level-up tokens (3Lxx)
    ...
    # 3) Apply FRLG corrections (birds at L1, starters early moves)
    out = _apply_frlg_overrides(species_name, out)
